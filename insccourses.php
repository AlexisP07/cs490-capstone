...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><a href="/cs490-capstone/logform.php#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>     <!-- to sign in/ register area -->
      </ul>
    </div>
  </div>
</nav>
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <?php
        ...
        $sql = "CALL getInscCourses";       /* gets all info sec info from db and formats to table */
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
            echo "<td><a href=inscdetail.php?courseNum=".urlencode($row['courseNum']).">".$row['courseNum']."</a></td>";
