...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><a href="/cs490-capstone/logform.php#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>     <!-- to login / register area -->
      </ul>
    </div>
  </div>
</nav>
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <?php
        ...
        $sql = "CALL getMathCourses";           /* getting all math info from db and formatting into table */
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
            echo "<td><a href=mathdetail.php?courseNum=".urlencode($row['courseNum']).">".$row['courseNum']."</a></td>";
