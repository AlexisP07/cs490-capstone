...
<body>
<form method="post" action="regform.php" > <!-- form, posting info to website -->
  <div class="container">
    <h1>Register</h1>
    ...
    <hr>
    <p align="center">Already have an account? <a href="/cs490-capstone/logform.php#">Sign in</a>.</p> <!-- links to sign in -->
