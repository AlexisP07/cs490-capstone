...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <?php 
        ...
        $sql = "SELECT * FROM astronomycourses WHERE courseNum='" . $courseNum . "'"; /* getting selected astr course details from db */
...
<footer class="container-fluid text-center">
    <p><a href="/cs490-capstone/astronomycourses.php#" title="Go to Astronomy Courses">Back to Astronomy Courses</a></p>
    <h5>
