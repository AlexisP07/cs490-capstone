...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><a href="/cs490-capstone/logform.php#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>     <!-- login/register area -->
      </ul>
    </div>
  </div>
</nav>
  ...
  <div class="row content">
    ...
    <?php
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
            echo "<td><a href=csdetail.php?courseNum=".urlencode($row['courseNum']).">".$row['courseNum']."</a></td>";
